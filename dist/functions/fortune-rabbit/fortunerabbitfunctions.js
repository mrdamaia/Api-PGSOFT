...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE fortunerabbitplayerjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonrabbit(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM fortunerabbitplayerjson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonrabbit(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO fortunerabbitplayerjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    attawcall(id, valor) {
