...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE fortunemouseplayerjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsonmouse(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM fortunemouseplayerjson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsonmouse(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO fortunemouseplayerjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
};
