...
exports.default = {
    ...
    savejsonspin(id, json) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("UPDATE fortunedragonplayerjson SET JSON = ? WHERE id = ?", [json, id]);
            return res[0];
        });
    },
    getjsondragon(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("SELECT * FROM fortunedragonplayerjson WHERE id=?", [id]);
            return res[0];
        });
    },
    createjsondragon(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO fortunedragonplayerjson (id) VALUES (?)", [id]);
            return res[0];
        });
    },
    attawcall(id, valor) {
